...
In this case, the format code will be `<emoji id="5334523697174683404">🤩</emoji>`.
...
In this case, the format code will be `<emoji id="5445350775582629332">🥳</emoji>`.

4. After obtaining the two format codes, you can use them to replace each other with the command:

{% code overflow="wrap" %}
```
/replace add rp_emoji_premium <emoji id="5334523697174683404">🤩</emoji> -> <emoji id="5445350775582629332">🥳</emoji>
```
{% endcode %}
