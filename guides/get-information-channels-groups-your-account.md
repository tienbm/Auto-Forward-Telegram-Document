...
# ℹ️ Get information channels, groups, your account
...
{% hint style="info" %}
This command is used to get a list of groups, bots, channels or users ID's for use [/forward ](how-to-create-task-auto-forward.md)command.
{% endhint %}
